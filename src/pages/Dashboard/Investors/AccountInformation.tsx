...
const AccountInformationComponent: FunctionComponent<AccountInformationPageProps> = ({
  ...
  const handleFetch = async () => {
    ...
    // const orderHistoryResponse: IGetOrderSummaryResponse = await getOrderSummary(request, navigation);
  ...
  const handleFetchOrderHistory = async () => {
    ...
    // const orderHistoryResponse: IDashboardResponse = await getDashboard(request, navigation, setIsFetching);
