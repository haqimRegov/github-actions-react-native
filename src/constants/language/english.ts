export const english = {
  PAGE: {
    ...
    PRODUCT_DETAILS: {
      ...
      LABEL_FUND_TYPE: "Fund Type",
      LABEL_LATEST: "Latest Fund Size",
      LABEL_MINIMUM: "Minimum Investment Amount",
      LABEL_RISK_CATEGORY: "Risk Category",
      LABEL_RISK: "Risk Category",
      LABEL_SALES_CASH: "Max. Sales Charge (Cash)",
      LABEL_SALES_EPF: "Max. Sales Charge (EPF)",
    ...
    RISK_ASSESSMENT: {
      ...
      QUESTION_3: "If your portfolio falls along with the market as shown in the chart below, what would you do?",
