...
export const CRS: ITermsAndConditions = {
  ...
  subsection: [
    ...
    {
      heading: "Definition of Selected Terms",
      termsList: [
        {
        ...
        },
        {
          ...
          content: "For definition of Malaysia Tax Resident, refer to the link:  http://lampiran.hasil.gov.my/pdf/pdfam/3656.pdf",
        },
      ],
    },
  ],
...
export const FEA: ITermsAndConditions = {
  ...
  subsection: [
    ...
    {
      heading:
        "PART II: Declaration For Investment In Foreign Currency Assets Onshore And Investment Abroad For Own Account (This section is applicable to a Resident with Domestic Ringgit Borrowing only)",
      termsList: [
        {
          content:
