export const english = {
  PAGE: {
    ...
    DASHBOARD_PROFILE: {
      ...
      LABEL_GENDER: "Gender",
      LABEL_GROSS: "Gross Annual Income",
    ...
    DECLARATION_SUMMARY: {
      ...
      SUBHEADING_FEA: "Principal account holder’s FATCA & CRS Declaration",
      SUBHEADING_JOINT: "Principal and Joint account holder’s FATCA & CRS Declaration",
      SUBHEADING_JOINT_FEA: "Principal and Joint account holder’s FATCA & CRS Declaration",
      TITLE_CRS: "CRS",
      TITLE_FATCA: "FATCA",
      TITLE_FEA: "FEA",
    ...
    EMPLOYMENT_DETAILS: {
      ...
      LABEL_HOUSEHOLD: "Monthly Household Income",
      LABEL_GROSS: "Gross Annual Income",
      LABEL_NATURE_BUSINESS: "Business Field",
    ...
    RISK_ASSESSMENT: {
      ...
      Q5_OPTION_2: "Redeem my investment partially",
      ...
      QUESTION_5: "If your portfolio decline inline with the market as shown in the chart below,\nwhat would you do?",
    ...
    SUMMARY: {
      ...
      LABEL_MARITAL: "Marital Status",
      LABEL_MOBILE_NUMBER: "Mobile Number",
      LABEL_MONTHLY: "Monthly Household Income",
