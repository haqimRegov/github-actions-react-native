export const english = {
  PAGE: {
    ...
    INVESTMENT: {
      ...
      SUBHEADING_NEW_SALES: "Review your selected funds and determine the investment / top-up amount and sales charge.",
    },
    ...
    PAYMENT: {
      ...
      LABEL_TOTAL_SALES_AMOUNT: "Total Sales Amount",
      LABEL_TRANSACTION_DATE: "Transaction Date",
      LABEL_TRANSACTION_TIME: "Transaction Time",
