export const english = {
  PAGE: {
    ...
    PERSONAL_DETAILS: {
      ...
      HEADING_ADD_ADDITIONAL: "Add Additional Details",
      HEADING_HELLO: "Hello",
      ...
      SUBTITLE_ADDITIONAL_DETAILS: "Click the Continue button to update your account information.",
    ...
    NEW_SALES_SUMMARY: {
      ...
      LABEL_FRONT: "Front",
      LABEL_HEADER: "Account Information Summary",
      LABEL_ID: "ID",
