export const english = {
  PAGE: {
    ...
    DASHBOARD_HOME: {
      ...
      LABEL_SUBMISSION_SUMMARY_DOWNLOADED: "Downloaded successful",
    ...
    DASHBOARD_PROFILE: {
      ...
      TITLE_BANK_SUMMARY: "Banking Information",
    ...
    DECLARATIONS: {
      ...
      LABEL_FORM_W8_BEN: "I agree to fill up and provide the adviser a hardcopy of Form W-8BEN",
    ...
    LOGIN: {
      ...
      SUBHEADING_LOGIN: "Login to your account.",
    ...
    RISK_ASSESSMENT: {
      ...
      POPUP_INCOME: "This refers to the combined income of the members within your household.",
      ...
      QUESTION_2: "How long do you plan to invest?",
      QUESTION_3: "How much investment experience do you have?",
      QUESTION_4: "If your portfolio decline inline with the market as shown in the chart below,\nwhat would you do?",
      QUESTION_5: "If you could choose only one of the three hypothetical portfolios characterized below, which would you choose?",
      QUESTION_6: "What percentage of your annual income will you invest?",
