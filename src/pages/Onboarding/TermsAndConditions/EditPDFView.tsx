...
export const PdfView: FunctionComponent<PDFViewProps> = ({
  ...
  const toolTipStyle: ViewStyle = { ...absolutePosition, zIndex: 1, top: sh14, width: sw84, left: sw20 };
        ...
        {completed === false ? (
          <View>
            <TouchableWithoutFeedback onPress={handleScroll}>
              <View style={{ ...absolutePosition, top: sh92, ...px(sw20) }}>
