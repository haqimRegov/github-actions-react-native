      ...
      termsList: [
        {
          content: [
            ...
            },
            {
              ...
              prefix: "11.",
              text:
                "In the event of systems failure, I/we consent to receive documents via post, fax or such other means as Kenanga Group deems fit and appropriate.",
            },
            {
              indentSpace: sw24,
              prefix: "12.",
              text:
                "I/We acknowledge that any documents sent to my/our email address provided to Kenanga Group herein by way of electronic means shall be deemed to be duly served on me/us on the day such communication by email was made.",
            },
            {
              indentSpace: sw24,
              prefix: "13.",
              text:
                "I/we shall assume all responsibilities or liabilities whatsoever for any direct or consequential losses arising from or in connection with Kenanga Group acting in accordance with my/our authorisation. I/We further agree to indemnify Kenanga Group against all actions, claims, demands, damages costs, charges and expenses which Kenanga Group may sustain, incur and be liable for as a result of or in consequence of or in connection with Kenanga Group acting in accordance with this authorisation.",
            },
          ],
        },
      ],
