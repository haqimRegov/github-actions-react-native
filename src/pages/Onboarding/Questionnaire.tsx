...
import { addAssessmentQuestions, getRiskAssessment, resetRiskAssessment, RootState } from "../../store";
import {
  flexRow,
  fs12SemiBoldBlack2,
  fs16BoldBlack1,
...
interface QuestionnaireContentProps extends OnboardingContentProps, ReduxStoreProps {
...
const QuestionnaireContentComponent = (props: QuestionnaireContentProps) => {
  ...
  const handlePageContinue = () => {
    ...
    props.getRiskAssessment(questionnaire!);
  };
  ...
  useEffect(() => {
    if (prevQuestionnaire !== undefined && JSON.stringify(questionnaire) !== JSON.stringify(prevQuestionnaire)) {
...
export const QuestionnaireContent = connect(mapStateToProps, mapDispatchToProps)(QuestionnaireContentComponent);
