export const english = {
  PAGE: {
    ...
    DASHBOARD_HOME: {
      ...
      LABEL_SUBMISSION_REPORT_DOWNLOADED: "Your report has been successfully downloaded to your computer.",
      LABEL_SUBMIT_HARD_COPY: "Submit Hard Copy Documents",
      LABEL_TOTAL_INVESTMENTS: "Total Investments",
      LABEL_TRANSACTION_TYPE: "Trans. Type",
      LABEL_UPLOAD_PROOF: "Upload Proof of Payment",
      LABEL_UPLOAD: "Upload Documents",
      LABEL_VIEW: "View",
    },
    DATE_PICKER: {
    ...
    PAYMENT: {
      ...
      CHECKBOX_LABEL: "This is under the assumption that the proof of payment and supporting documents are in order.",
    ...
    UPLOAD_HARD_COPY_DOCUMENTS: {
      ...
      LABEL_HARD_COPY_SUBMISSION: "Hard Copy Document Submission",
      LABEL_HARD_COPY_SUBMITTED: "Hard Copy document updated successfully",
