export const DICTIONARY_MOBILE_CODE: IMobileCountryCode[] = [
  ...
  { label: "684 American Samoa", value: "+1-684" },
  ...
  { label: "Dominican Republic", value: "+1-829" },
  { label: "Dominican Republic", value: "+1-849" },
