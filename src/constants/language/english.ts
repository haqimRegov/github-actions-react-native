export const english = {
  PAGE: {
    ...
    INVESTOR_INFORMATION: {
      ...
      CARD_TITLE_EMAIL: "Please provide your personal email address in order to avoid any discrepancies.",
      ...
      LABEL_VERIFY: "Verify",
      LINK_RESEND: "Resend",
      SUBHEADING_EMAIL: "Investor Email Update",
      SUBTITLE_CONTACT_SUMMARY: "The new email address and mobile number will overwrite all accounts existing value.",
      SUBTITLE_EMAIL_UPDATE:
        "Update on email address is required for new KIB App users.\nThe new email address will overwrite all accounts existing value.",
