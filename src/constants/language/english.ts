export const english = {
  PAGE: {
    ...
    LOGIN: {
      ...
      LABEL_PASSWORD_UPDATED_SUBHEADING: "Your password has been changed successfully.Use your new password to log in.",
    ...
    TERMS_AND_CONDITIONS: {
      ...
      LABEL_FUND: "Fund",
      LABEL_JOINT_SIGNATURE: "Joint Holder’s Signature (optional)",
      LABEL_MYR: "MYR",
