...
import { Signer } from "./EditPDFView";
import { NewPdfView } from "./NewEditPDFView";
...
export const NewEditPdf = connect(AcknowledgementMapStateToProps, AcknowledgementMapDispatchToProps)(NewEditPdfComponent);
